...
namespace We7.CMS.Web.Widgets
{
    ...
    public partial class Article_MultiList : ThinkmentDataControl
    {
        /// <summary>
        /// 文章业务助手
        /// </summary>
        ...
        protected Boolean GetShow(string strAll, string strTags)
        {
            Boolean ret = false;
            if (strAll == "all")
            {
            ...
            else if (string.IsNullOrEmpty(strTags) == true && strTags != "不对外")
            {
                ret = true;
            }
            return ret;
