    ...
    public partial class EnDefault : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                OldDbCate1.DataSource = oldDB.NewsTypeEn.Where(x => x.BigId == 11 || x.BigId == 31);
        ...
        protected void ImportToNewDb_Click(object sender, EventArgs e)
        {
            ...
            foreach (var article in articles)
            {
                try
                {
                    ...
                    a.Title = article.TitleEn.Trim();
                    a.Index = 999;
                    a.AllowComments = 0;
                    a.IsShow = 0;
                    a.Author = string.IsNullOrEmpty(article.FromtoEn.Trim())!=true?article.FromtoEn.Trim():"WISE";
                    a.State = 1;
                    a.ContentType = 0;
                    a.IsImage = 0;
                    a.Content = article.ContentEn.Trim();
