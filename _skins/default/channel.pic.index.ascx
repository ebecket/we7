...
<%@ Register Src="/Widgets/WidgetCollection/Article/Article.Default.PagedList/Article.Default.PicPagedList.ascx"
    ...
    <div id="wrap">
        ...
        <div id="main_wrap">
            <div id="main">
                ...
                <div id="main_inner">
                    <wew:Article_PagedList ID="paged_list" CssClass="module paged_list pic_paged_list co_paged_list" pager-pagesize="100"
                        titlelength="80" includechildren="False" dateformat="yyyy-MM-dd" pager-requestpageindex="page"
                        pager-vmtemplatefilename="/Widgets/WidgetCollection/Article/Article.Default.PagedList/pager.vm" thumbnailtag="co"
