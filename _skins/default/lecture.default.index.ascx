...
<%@ Register Src="/Widgets/WidgetCollection/Lecture/Lecture.Default.PagedList/Lecture.Default.PagedList.ascx"
    TagName="Lecture_PagedList" TagPrefix="wew" %>
...
<%@ Register Src="/Widgets/WidgetCollection/Static/Static.Default.SideMenu/Static.Default.SubSeminarMenu.ascx"
    TagName="Static_SubSeminarMenu" TagPrefix="wew" %>
...
<body>
    <div id="wrap">
        ...
        <div id="main">
            ...
            <div id="main_inner">
                <div id="listleft">
                    <wew:Static_SubSeminarMenu ID="SubSeminarMenu" CssClass="sub_menu" runat="server">
                    </wew:Static_SubSeminarMenu>
                </div>
                <div id="listright">
                    <wew:Lecture_PagedList ID="paged_list" CssClass="module paged_list event_paged_list"
                        ...
                        QueryByColumn="true"></wew:Lecture_PagedList>
                    <div class="auto">
                    </div>
                </div>
            </div>
