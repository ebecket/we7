...
<%@ Register Src="/Widgets/WidgetCollection/Article/Article.PagedList/Article.PagedList2.ascx"
    TagName="Article_PagedList2" TagPrefix="wew" %>
    ...
    <div id="warp">
        <div id="main">
            <wew:Header_Default filename="/Widgets/WidgetCollection/Header/Header.Default/Header.Default.ascx"
                ID="header" runat="server" CssClass="header">
            </wew:Header_Default>
            <div id="container">
                <div class="left">                    
                    <wew:Article_PagedList2 ID="paged_list" CssClass="module paged_list paged_list_xmuview" pager-pagesize="20"
                        titlelength="82" includechildren="False" dateformat="MM-dd" pager-requestpageindex="page"
                        pager-vmtemplatefilename="/Widgets/WidgetCollection/Article/Article.PagedList/pager.vm"
                        pager-pagerdivclass="pager-container" pager-pagerspanclass="pager" filename="/Widgets/WidgetCollection/Article/Article.PagedList/Article.PagedList.ascx"
                        runat="server">
                    </wew:Article_PagedList2>
                </div>
                <div class="right">
