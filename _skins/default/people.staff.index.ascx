...
<%@ Register Src="/Widgets/WidgetCollection/People/People.Default.PagedList/People.Staff.PagedList.ascx"
    ...
    <div id="wrap">
        ...
        <div id="main_wrap">
            <div id="main">
                ...
                <div id="main_inner">
                    <wew:People_PagedList ID="paged_list" CssClass="module paged_list faculty_paged_list" pager-pagesize="100"
