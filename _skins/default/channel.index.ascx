...
<body>
    <div id="wrap">
        ...
        <div id="main">
            ...
            <div id="main_inner">
                <div id="listleft">
                    <wew:Static_SideMenu ID="side_menu" CssClass="leftNav" runat="server"></wew:Static_SideMenu>
                </div>
                <div id="listright">
                    <wew:Article_PagedList ID="paged_list" CssClass="module paged_list" pager-pagesize="20"
                        titlelength="74" includechildren="False" dateformat="yyyy-MM-dd" pager-requestpageindex="page"
