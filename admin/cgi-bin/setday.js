...
document.writeln('<table style=" border:0px; width:142px; height:160px; background-color:#000000;" cellspacing="1" cellpadding="0"  onselectstart="return false">');
document.writeln('  <tr><td width=142 height=23 bgcolor=#FFFFFF><table class=tree border=0 cellspacing=1 cellpadding=0 width=140 height=23>');
document.writeln('      <tr align=center><td width=20 align=center bgcolor=#808080 style="font-size:12px;cursor: hand;color: #FFD700;background:#808080" ');
...
document.writeln('        <td width=20 bgcolor=#808080 align=center style="font-size:12px;cursor: hand;color: #FFD700; background:#808080" ');
...
document.writeln('<table class=tree border=0 cellspacing=0 cellpadding=0 width=140 height=1 style="cursor:default">');
document.writeln('<tr align=center><td style="font-size:12px;color:#FFFFFF;background:#808080" Author=meizz>日</td>');
document.writeln('<td style="font-size:12px;color:#FFFFFF; background:#808080" Author=meizz class="td1">一</td><td style="font-size:12px;color:#FFFFFF; background:#808080" Author=meizz>二</td>');
document.writeln('<td style="font-size:12px;color:#FFFFFF; background:#808080" Author=meizz>三</td><td style="font-size:12px;color:#FFFFFF; background:#808080" Author=meizz>四</td>');
document.writeln('<td style="font-size:12px;color:#FFFFFF; background:#808080" Author=meizz>五</td><td style="font-size:12px;color:#FFFFFF; background:#808080" Author=meizz>六</td></tr>');
...
document.writeln('    <table class=tree border=0 cellspacing=1 cellpadding=0 width=140 height=120 bgcolor=#FFFFFF>');
...
document.writeln('        <table class=tree border=0 cellspacing=1 cellpadding=0 width=140 bgcolor=#FFFFFF>');
document.writeln('          <tr align=center><td Author=meizz align=left><input Author=meizz type=button value="<<" title="前一年" onclick="meizzPrevY()" ');
