...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <div>
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="FieldDataTypeDropDownList" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="ChangeType">
            ...
            ControlToValidate="MaxlengthTextBox" ErrorMessage="必须为正整数!" 
        ...
        <div class="toolbar">
            ...
            <asp:HyperLink ID="ReturnHyperLink" NavigateUrl="FieldManage.aspx?modelname=<%=ModelName%>"
                runat="server">
            返回列表
            </asp:HyperLink>
        </div>
