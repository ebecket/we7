...
function reNumber(num) {
    ...
    <script  type="text/javascript" src="<%=AppPath%>/Ajax/jquery/ui1.8.1/ui/jquery.ui.core.js" ></script>    
    <script type="text/javascript" src="<%=AppPath%>/Ajax/jquery/ui1.8.1/ui/jquery.ui.widget.js" ></script>
    <script type="text/javascript" src="<%=AppPath%>/Ajax/jquery/ui1.8.1/ui/jquery.ui.mouse.js" ></script>
    <script type="text/javascript" src="<%=AppPath%>/Ajax/jquery/ui1.8.1/ui/jquery.ui.draggable.js" ></script>
...
<div id="main">
    ...
    <div class="conbox">
        <div id="conbox">
            <dl>
                <dt>» 设置文章缩略图<br/>
                    <img src="/admin/images/bulb.gif" align="absmiddle" alt="" /><label class="block_info">文章缩略图可以用在头条新闻、wap或图片新闻的缩略图阵列展示中。打开cookie功能，可以自动保存上次设置状态。</label></dt>
                    <dd>     
                    ...
                    <div id="resourceFrame">
                        <div id="bg_image">
                            <img id="o_image" src="<%=OriginalImagePath %>"  alt="" />
                        </div>
                        <div id="drop">
                            <img id="drop_image" src="<%=OriginalImagePath %>" alt="" />
                        </div>
                    </div>
                    <center>
            ...
            <%=this.width %></label>px  高：<label id="height" class="Hidden"><%=this.height%>px</label><br />
                            ...
                            <asp:DropDownList ID="SizesDropDownList" runat="server" AutoPostBack="false" class="size_ddl">
                            </asp:DropDownList>
                            <asp:DropDownList ID="CutTypeDropDownList" runat="server"  
                                        onblur="saveImageCutToCookies(this)"  >
                                <asp:ListItem Value=''>--请选择裁切模式--</asp:ListItem>
                                ...
                                <asp:ListItem Value="CustomerCut" Selected="True">手动：按左图框定裁切</asp:ListItem>
                            </asp:DropDownList>
                            <br />
                         ...
                         图片实际宽度： <input type="text" id="txt_width" readonly="readonly" /><br />
                         图片实际高度： <input type="text" id="txt_height" readonly="readonly" /><br />
                         距离顶部： <input type="text" id="txt_top" readonly="readonly" /><br />
                         距离左边： <input type="text" id="txt_left" readonly="readonly" /><br />
                         截取框的宽：<input type="text" id="txt_DropWidth" readonly="readonly" /><br />
                         截取框的高： <input type="text" id="txt_DropHeight"  readonly="readonly"/>  <br />
                         放大倍数：  <input type="text" id="txt_Zoom"  readonly="readonly"/><br />
                        </div>                       
                        </td>
                       </tr>
                    </table>          
                    ...
                    <ItemTemplate>
                            <tr>
                                <td  style="text-align:left;border-bottom:dotted 1px #aaa;width:200px;">
                                    <img id="Img1" alt="" src="<%# Eval("ImagePath") %>" width="200px" />
                                </td>
                                <td style="text-align:left;border-bottom:dotted 1px #aaa;width:200px;">
