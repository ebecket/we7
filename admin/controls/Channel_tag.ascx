<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Channel_tag.ascx.cs" Inherits="We7.CMS.Web.Admin.controls.Channel_tag" %>
<DIV class=TagsList>
  <DIV id=conbox>             
  <DL>
  <DT>»栏目标签<br />
  <img src="/admin/images/bulb.gif" align="absmiddle"/> <LABEL 
  class=block_info>栏目标签用于为栏目分组，和与文章关联。下面的系统标签与常用标签点击即可加入为本篇文章的标签。</LABEL> 
    <DD>
<UL id="tagList">
 <asp:Literal ID="TagListLitiral" runat="server"></asp:Literal>
 </UL>

<INPUT class=txt id=tagNameInput name=tagNameInput  > 
