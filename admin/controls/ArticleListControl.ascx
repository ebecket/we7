...
<div class="toolbar2">
    ...
    <li runat="server" id="CopyToSpan" class="smallButton4">
        <asp:HyperLink ID="CopyToHyperLink" NavigateUrl="javascript:selectChannels('article');" runat="server">
...
<%--    <li class="smallButton4">
    ...
    <li class="smallButton4">
     ...
     <li class="smallButton6">
        <asp:HyperLink ID="ArticleTreeHyperLink" CssClass="ArticleTree" NavigateUrl="ArticleTree.aspx" runat="server" Visible="false" >
          文章树关系
        </asp:HyperLink>
    </li>
    <li class="smallButton4">
