    ...
    <dl>
        <dt>»文章/稿件的基本信息<br>
            ...
            <dd>
                ...
                <div id="titlediv">
                    标题：<input class="TitleText" id="TitleTextBox" runat="server" size="30" title="文章的主标题，请仔细填写，不可以为空。"
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="formValue" style="vertical-align:bottom;">
                                        ...
                                        &nbsp;
                                        <asp:DropDownList ID="ddlColor" runat="server" Style="text-align: center; font-size:10px;padding:0px; margin:0px; vertical-align:middle">
                                ...
                                <tr>
                                    ...
                                    <td class="formValue" id="authorTd">
                                        <input runat="server" id="AuthorTextBox" class="txt" style="width: 250px" onchange="contentEdited(true);"> 
										<span>学院新闻栏目必填，用于新闻统计<span>
										<script type="text/javascript"> if($("#titlediv input").val()){}else{$("#authorTd input").val("");} </script>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="formTitle">
                ...
                <input class="Btn" id="SaveButton2" runat="server" type="submit" value="保存文章信息" onserverclick="SaveButton_ServerClick" />
                <br />
    </dl>
