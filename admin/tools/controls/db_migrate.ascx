<%@ Control Language="C#" AutoEventWireup="true" Codebehind="db_migrate.ascx.cs"
    Inherits="We7.CMS.Web.Admin.controls.db_migrate" %>
...
<div id="conbox">
    <dl>
        <dt>»数据库迁移<br />
            <img src="/admin/images/bulb.gif" align="absmiddle" alt="" /><label class="block_info">您可以将当前数据库转化到其他类型，如SQL Server或SQLite</label>
        </dt>
    </dl>
    <div style="display:table;width:100%;padding-left:50px">
       <p>
            <span >
            <h3 class="summary2">
            <asp:Literal  ID="DBSummaryLiteral" runat="server"  ></asp:Literal>
            </h3>
             </span>
        </p>
            <table cellspacing="0" cellpadding="8" style="width:300px" border="0" >
                ...
                <tr id="tr5">
                  ...
                  <tr>
                    <td></td>
                    <td >
                    <asp:CheckBox runat="server" ID="CreateNewDBCheckBox" Text="创建新数据库" Checked="true" />
                   </td>
                </tr>
            </table>
             <asp:Button ID="ExecuteButton" runat="server" Height="25px" OnClick="ExecuteButton_Click"
            Text="开始迁移" Width="151px" class="Btn" /><br />
        <div>
