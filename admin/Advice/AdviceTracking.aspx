...
<script type="text/javascript" language="javascript" src="../cgi-bin/setday.js"></script>
    ...
    <div>
        ...
        操作时间：从<input id="StartTimeText" value="请点击选择日期" runat="server" type="text" onfocus="setday(this)"
            readonly="readOnly" style="width: 170px" />
        到<input id="EndTimeText" runat="server" type="text" value="请点击选择日期" onfocus="setday(this)"
            readonly="readOnly" style="width: 170px" />
