            ...
            <dd>
                <table class='tree'>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="javascript:openEditLayoutWindow();" >编辑这个模型的表单布局</a> |  <a href="/admin/ContentModel/EditModel.aspx?action=add&type=Template.AdviceModel" target="_blank">新建反馈模型表单</a> 
                        </td>
                    </tr>
                </table>
                <div class="toolbar">
                    <asp:HyperLink ID="HyperLink1" NavigateUrl="javascript:onSaveButtonClick();" runat="server">保存</asp:HyperLink>
                    <br />
                </div>
