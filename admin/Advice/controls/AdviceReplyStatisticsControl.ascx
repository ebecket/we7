...
<script type="text/javascript" language="javascript" src="<%=AppPath%>/cgi-bin/setday.js"></script>
    ...
    <dl>
        ...
        <dd style="width: 650px">
            <div style="display: table; width: 100%">
                ...
                <p class="search-box">
                    反馈信息统计： 从<input id="starttime" onclick="setday(this)" name="starttime" runat="server"
                        style="width: 92px" />
                    到
            ...
            <div class="pagination">
                <WEC:Pager ID="AdviceReplyStatisticsPager" PageSize="10" PageIndex="0" runat="server" OnFired="Pager_Fired" />
