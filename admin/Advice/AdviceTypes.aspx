...
//        }
    ...
    <h2 class="title">
        ...
        <asp:Label ID="NameLabel" runat="server" Text="互动反馈模型管理">
        </asp:Label>
        <span class="summary">
            <asp:Label ID="SummaryLabel" runat="server" Text="系统允许自定义多种反馈模型，反馈模型同时生成对应菜单，位于<反馈>主菜单下。">
            </asp:Label>
        </span>
    </h2>
    <div class="toolbar">
    ...
    <div>
        <asp:GridView ID="DataGridView" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID" HeaderText="模型名称" DataNavigateUrlFormatString="AdviceTypeEdit.aspx?adviceTypeID={0}"
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href="../manage/AddFeedbackMenu.aspx?menuTypeID=<%# Eval("ID") %>&menuName=<%# Eval("Title") %>"
                            class="addMenu">将此模型加入到菜单</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
