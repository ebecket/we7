...
#templateConfigContainer h3 { margin-top:15px;}
    ...
    <div class="toolbar" style="display: <%=ToolbarVisible%>">
        ...
        <div>
            <a href="#"  id="button">新建模板▼</a></div>
        </li>
         <li class="smallButton8" >
            <a href="TemplateFileDetail.aspx"  id="createVisualTemplate">新建可视化模板▼</a>
        </li>
        <li class="smallButton4">
        ...
        <li class="smallButton6">
            <asp:HyperLink ID="FilesHyperLink" NavigateUrl="/Admin/FileManagement.aspx" runat="server">
                 模板文件目录</asp:HyperLink></li>
        <li class="smallButton8">
            <asp:LinkButton runat="server" ID="CreateMapLink" OnClick="CreateMapLink_Click">重建模板索引图</asp:LinkButton></li>
       <%-- <li class="smallButton8">
            <asp:LinkButton runat="server" ID="CreateControlIndex" OnClick="CreateControlIndex_Click">重建控件索引</asp:LinkButton></li>--%>
        <li class="smallButton8">
            <asp:LinkButton runat="server" ID="CreateWidgetIndex" OnClick="CreateWidgetIndex_Click">重建部件索引</asp:LinkButton></li>
            <li class="smallButton8">
            <asp:LinkButton runat="server" ID="CreateThemeIndex" OnClick="CreateThemeIndex_Click">重建主题索引</asp:LinkButton></li>
        <li class="smallButton4">
