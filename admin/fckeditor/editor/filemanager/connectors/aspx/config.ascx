...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
        ...
        // return true;
        return !String.IsNullOrEmpty(We7.CMS.Accounts.Security.CurrentAccountID) || Request.IsAuthenticated;
	}
	...
	public override void SetConfig()
	{
        ...
        if (Session["WorkPlace"] != null && Session["WorkPlace"].ToString() == "compose")
        {
            AutoResizeImage = false;
            UserFilesPath = Session["COMPOSE_URL"] as string;
        }
        else
        {
            AutoResizeImage = true;
            UserFilesPath = Session["ARTICLEDETAIL_CHANNELFILEPATH"] as string;// "/_data/watermark/";
        }
		...
		TypeConfig[ "File" ].AllowedExtensions			= new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xml", "zip", "docx", "pptx", "xlsx" };
