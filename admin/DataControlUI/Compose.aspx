    ...
    <div id="wrap">
        <h2 class="title">
            ...
            保存到文件
                ...
                <asp:TextBox runat="server" style="font-size:12px;width:150px"  ID="FilenameTextBox" Text="templateName.ascx"   ></asp:TextBox>
            </span>
            <span class="copyTool">
                  <asp:DropDownList ID="PrevewDropDownList" runat="server" onchange="MM_openMenu(this,1)" ></asp:DropDownList>
                    <span id="PublishSpan" runat="server" ><a href="javascript:publishThisCopy()"><img src="/admin/images/t-publish.png" alt="发布" /></a></span>
              </span>
              <div id="buttonShow" style="padding-top:20px;padding-right:10px;display:none">
                <asp:HyperLink ID="CurrentFolderHyperLink" runat="server" ToolTip="点击进入管理文件" Target="_blank" > <u>当前模板所在文件夹</u>
                </asp:HyperLink>
             </div>
        </h2>
