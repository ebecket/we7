    ...
    <div style="margin-top: 10px">
        <div id="container-1">
            <ul>
                ...
                <li><a id="#fragment-7" href="#fragment-7"><span>IP过滤</span></a></li>
            </ul>
            <div id="fragment-1">
                <table style="border: solid 0px #fff;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSN" runat="server" TextMode="MultiLine" Width="300px" Height="70px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <asp:TextBox ID="txtSSOUrls" runat="server" TextMode="MultiLine" Rows="6" Columns="60"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr>
                        <td align="right">
            ...
            <div id="fragment-5">
                <table style="border: solid 0px #fff;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="IpSecurityCheckBox" runat="server" />开启IP安全策略
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <asp:RadioButton runat="server" ID="AllowRadioButton" GroupName="IpSecurity" Text="允许"
                                Checked="true" />
                            <asp:RadioButton runat="server" ID="ForbiddenRadioButton" GroupName="IpSecurity"
                                Text="禁止" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="StartPageViewModuleCheckBox" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
