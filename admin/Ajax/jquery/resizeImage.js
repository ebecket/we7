...
function changeFrame(v) {
    ...
    if (size) {
        ...
        $("#drop").css({ width: width + "px", height: height + "px" });
        $("#txt_DropWidth").val(width);
        $("#txt_DropHeight").val(height);
        if (width + 200 > 800) $("#resourceFrame").width(width + 200);
        else $("#resourceFrame").width(800);
        if (height + 200 > 400) $("#resourceFrame").height(height + 200);
        else $("#resourceFrame").height(400);
