                            ...
                            <asp:GridView ID="PluginListGridView" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作" ItemStyle-VerticalAlign="Middle">
                                        ...
                                        <ItemTemplate>
                                            <input type="button" class="Btn" value='<%# CheckInstalled(Eval("Url"))?"更新":"安装" %>'
                                                onclick="submitSingleAction('<%# CheckInstalled(Eval("Url"))?"remoteupdate":"remoteinstall" %>','<%# Eval("Url") %>');return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
