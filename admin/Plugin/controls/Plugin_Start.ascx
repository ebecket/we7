                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td style="width:50px">
                                <asp:Button ID="QueryButton" runat="server" Text="搜索"  CssClass="button"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="UploadButton" runat="server" Text="添加插件" OnClick="UploadButton_Click"  CssClass="button" />
                            </td>
                        </tr>
                        <tr>
                            <td>
