<%@ Page Language="C#" MasterPageFile="~/admin/theme/classic/content.Master" AutoEventWireup="true"
    CodeBehind="UserMenulist.aspx.cs" Inherits="We7.CMS.Web.Admin.manage.UserMenulist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <div class="toolbar">
        ...
        <li class="smallButton8">
            <asp:HyperLink ID="AddMenuHyperLink" NavigateUrl="AddMenuUser.aspx" runat="server">
            从内容模型新建菜单
            </asp:HyperLink>
        </li>
    </div>
    ...
    <div style="display: table; width: 100%">
        ...
        <p class="search-box">
            <label class="hidden" for="user-search-input">
                搜索菜单:</label>
            <input type="text" class="search-input" id="KeyWord" name="KeyWord" value="" onkeydown="javascript:KeyPressSearch('UserMenulist.aspx',event);" />
            <input type="button" value="搜索菜单" class="button" id="SearchButton" onclick="javascript:doSearch('UserMenulist.aspx');" />
        </p>
    </div>
    <div>
