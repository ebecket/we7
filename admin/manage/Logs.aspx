                            ...
                            <table class='tree'>
                                <tr valign="top">
                                    <td style="height: 30px">
                                        时间：从<input id="starttime2" onclick="setday(this)" size="12" name="starttime" runat="server" />
                                        到<input id="endtime2" onclick="setday(this)" size="12" name="endtime" runat="server" />
                                        的日志
                                    </td>
                                </tr>
                                <tr>
