<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishStatisticses.aspx.cs" Inherits="We7.CMS.Web.Admin.PublishStatisticses" %>
...
<asp:Content ID="We7Content" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <h2 class="title">
        ...
        <asp:Label ID="NameLabel" runat="server" Text="发布量与效果统计分析">
        </asp:Label>
        <span class="summary">
