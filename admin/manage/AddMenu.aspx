<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMenu.aspx.cs" Inherits="We7.CMS.Web.Admin.AddMenu"
    Title="内容模型自定义菜单" %>
...
<asp:content id="We7Content" contentplaceholderid="MyContentPlaceHolder" runat="server">
    ...
    <h2 class="title">
        ...
        <span class="summary">
            <asp:Label ID="SummaryLabel" runat="server" Text="内容模型菜单包括文章信息,展会,产品等">
            </asp:Label>
        </span>
    </h2>
         ...
         <div>        
            ...
            <table  class="personalForm" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="formValue">
                        <asp:TextBox ID="ReleaseTitleTextBox" runat="server" Columns="60"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ReleaseTitleTextBox"
                            ErrorMessage="不能为空" ValidationGroup="SubmitButton"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="formValue">
                        <asp:TextBox ID="ReleaseDesTextBox" runat="server" Columns="60"></asp:TextBox><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator7" runat="server" ControlToValidate="ReleaseDesTextBox" ErrorMessage="不能为空"
                            ValidationGroup="SubmitButton"></asp:RequiredFieldValidator>
                    </td>
                </tr>                 
                <tr>
                    ...
                    <td class="formValue">
                        <asp:TextBox ID="ReleaseUrlTextBox" runat="server" Columns="60"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ReleaseUrlTextBox"
                            ErrorMessage="不能为空" ValidationGroup="SubmitButton"></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
