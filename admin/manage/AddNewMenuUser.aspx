<%@ Page Title="" Language="C#" MasterPageFile="~/admin/theme/classic/content.Master" AutoEventWireup="true"
    CodeBehind="AddNewMenuUser.aspx.cs" Inherits="We7.CMS.Web.Admin.AddNewMenuUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <div class="toolbar">
        <a id="AddHyperLink" href="javascript:SubmitClick();" style="display: <%= MenuMainvisble %>">保存1</a> <a id="SaveHyperLink"
            href="javascript:SaveClick();"  style="display: <%= MenuChildvisble %>">保存2</a>
