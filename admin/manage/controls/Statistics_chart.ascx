<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Statistics_chart.ascx.cs" Inherits="We7.CMS.Web.Admin.Statistics_chart" %>
    ...
    {
        var url= "../OpenFlashChart/area.aspx?begin="+fromTime+"&end="+toTime;
...
//    debugger;
    ...
    function formatDate(now,months)
    {
         var date=new Date();
          y=now.getFullYear();
          m=now.getMonth()+1+months;
          if(!m)
          {
            y=y-1;
            m=12;
