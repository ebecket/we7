...
<asp:Content ID="We7Content" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <div class="toolbar">
        ...
        <li>
            <asp:LinkButton ID="lnkEdit" OnClientClick="return submitAction(true);" runat="server"
                Text="编辑"></asp:LinkButton>
        </li>
        <li>
            <asp:LinkButton ID="lnkDel" OnClientClick="return submitAction(false);" runat="server"
