<%@ Page Language="C#" MasterPageFile="../theme/classic/content.Master" AutoEventWireup="true"
    CodeBehind="EditScoreLevel.aspx.cs" Inherits="We7.CMS.Web.Admin.ScoreManager.EditScoreLevel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <div id="position">
        <a href='/admin/' target='_parent'>开始</a> > <a href='/admin/scoremanager/ScoreSubjectList.aspx'>
            积分主题管理 </a>> <a href='/admin/scoremanager/EditScoreSubject.aspx?id=<%= SubjectID %>&tab=2'
                id='pathLast'>等级</a> >
    ...
    <div id="mycontent">
        ...
        <div class="Tab menuTab">
            <ul id="ScoreSubjectMenu" class="Tabs">
                <span id="ctl00_MyContentPlaceHolder_MenuTabLabel">
                    ...
                    <li style="" id="tab2" class="TabIn"><a><%=CurrSubjectName%>等级</a> </li>
                    <li style="" id="tab3" class="TabOut"><a href="/admin/ScoreManager/EditScoreSubject.aspx?id={39a9e225-f593-4b3e-a83c-8b8663dc480d}&amp;tab=3">
                        <%=CurrSubjectName %>规则</a> </li>
                </span>
            </ul>
        </div>
        <div class="clear">
        ...
        <dl>
            <%--»等级<br />--%>
            <dt>
                <img src="/admin/images/bulb.gif" align="absmiddle" alt="" /><label class="block_info" id="lblTip" runat="server">等级；</label>
            </dt>
            <dd>
                <table id="subjectForm" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="formValue">
                            <asp:TextBox ID="MinTextBox" runat="server" Columns="2" CssClass="txt"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="formTitle">
                        ...
                        <td class="formValue">
                            <asp:TextBox ID="MaxTextBox" runat="server" Columns="2" CssClass="txt"></asp:TextBox>
                        </td>
                    </tr>
                     <tr>
                    <td class="formTitle">
                    ...
                    <td class="formValue">
                        <asp:RadioButtonList ID="IsDefaultRadios" runat="server" 
